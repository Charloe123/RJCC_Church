      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200/80 p-8 shadow-sm">
        ...
        <div className="mb-7">
          ...
          <p className="text-slate-500 text-base leading-normal font-normal">
            Enter your credentials to access the usher portal
          </p>
        </div>
...
{/* Email Field */}
        ...
        <div className="border-t border-slate-100 mt-6 pt-5 text-center">
          <p className="text-sm text-slate-500 font-medium">
            Church member or admin? <button type="button" onClick={() => navigate('/')} className="text-black font-bold hover:underline">Back to Login Types</button>
          </p>
        </div>
      </div>
